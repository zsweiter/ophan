...
pub enum MatchError {
    ...
    NotFound,
    /// The HTTP method is not allowed for this virtual host.
    MethodNotAllowed,
...
impl fmt::Display for MatchError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::MethodNotAllowed => write!(f, "HTTP method not allowed"),
            Self::HostNotFound => write!(f, "No matching virtual host"),
        }
    }
}
